...
const { testButtons, scheduler, messageInfoControl, getCCDCCData, sendFromDCC, sendFromYandal, handleLocMessage, handleKWHMessage, cekPiketCS, cekPiketDCC, cekPiketCT, cekPiketYantekAll, cekPiketYantek, ping, sendMessageToNumber } = require('./controls.js');
